...
function Footer(){
    ...
    return(
        ...
        {/* vh is relative unit */}
        <footer className='relative left-0 bottom-0 h-[10vh] mt-[3%] py-5 flex flex-col sm:flex-row items-center justify-between text-white bg-gray-800 sm:px-20 w-full'>
